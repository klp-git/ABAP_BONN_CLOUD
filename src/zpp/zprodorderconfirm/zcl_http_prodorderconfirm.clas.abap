  ...
  METHOD validate.
    ...
    LOOP AT filled_details-_goodsmovements INTO DATA(ls_goodsmovement) WHERE quantity GT 0.
      ...
      IF ls_goodsmovement-plant IS INITIAL.
        message = |Plant is mandatory for material { ls_goodsmovement-material }| .
        RETURN.
      ELSEIF ls_goodsmovement-storagelocation IS INITIAL.
        message = |Storage location is mandatory for material { ls_goodsmovement-material }| .
      ENDIF.
      ...
      ELSE.
        ...
        IF res1-IsBatchManagementRequired  = 'X' AND ls_goodsmovement-batch IS INITIAL.
          message = |Batch is mandatory for material { ls_goodsmovement-material }|.
          RETURN.
        ENDIF.
