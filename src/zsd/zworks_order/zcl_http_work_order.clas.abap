...
*     req_uri = request->get_request_uri( ).
    ...
    req_uri = '/sap/bc/http/sap/ZCL_HTTP_WORK_ORDER?sap-client=080'.
    ...
    CASE request->get_method( ).
      ...
      WHEN CONV string( if_web_http_client=>post ).
        DATA: vbeln TYPE I_salesdocument-SalesDocument.
        vbeln = request->get_form_field( `lot` ).
