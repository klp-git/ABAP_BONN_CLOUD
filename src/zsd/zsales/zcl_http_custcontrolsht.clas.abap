CLASS  zcl_http_custcontrolsht DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CLASS-DATA it_master TYPE TABLE OF  zcustcontrolsht.
...
CLASS ZCL_HTTP_CUSTCONTROLSHT IMPLEMENTATION.
...
*                wa_final_master-last_changed_at  = cl_abap_context_info=>get_system_time( ).
                ...
                MODIFY zcustcontrolsht FROM @wa_final_master.
