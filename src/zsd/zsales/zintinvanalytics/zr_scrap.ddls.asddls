...
@EndUserText.label: 'View Entity for ZDT_RPLCREDITNOTE->Scrap'
...
define view entity ZR_SCRAP as select from zdt_rplcrnote
  association to parent ZR_INVGROUPED000 as _Group on $projection.Imdate = _Group.Orderdate and $projection.Type = _Group.Type
{
    ...
    scrapindoc as Scrapindoc,
     case when processed = '1' then 0 else 1 end as Highlight,
