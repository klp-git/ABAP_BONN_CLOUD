CLASS zcl_http_sales_team DEFINITION
  PUBLIC
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-DATA it_master TYPE TABLE OF zsales_team_tab.
...
CLASS ZCL_HTTP_SALES_TEAM IMPLEMENTATION.
...
*          READ TABLE it_final_order INTO DATA(wa_final_order) INDEX 1.
*
...
*           wa_final_order-last_changed_at      = Cl_abap_context_info=>get_system_time( ).
          ...
          MODIFY zsales_team_tab FROM @wa_final_master.
