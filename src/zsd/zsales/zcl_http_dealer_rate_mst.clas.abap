CLASS  zcl_http_dealer_rate_mst DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CLASS-DATA it_master TYPE TABLE OF zdealer_ratemst1.
...
CLASS ZCL_HTTP_DEALER_RATE_MST IMPLEMENTATION.
 ...
 response->set_text( 'data saved successfully' ).
        ...
        IF it_final_master  IS NOT INITIAL.
          ...
          MODIFY zdealer_ratemst1 FROM @wa_final_master.
