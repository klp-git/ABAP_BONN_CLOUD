CLASS  zcl_http_cashroomcr DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CLASS-DATA it_master TYPE TABLE OF zcashroomcrtable.
...
CLASS ZCL_HTTP_CASHROOMCR IMPLEMENTATION.
        ...
        IF lv_body IS NOT INITIAL.
          ...
          TRY.
              ...
              IF it_final_master IS NOT INITIAL.
                ...
                MODIFY zcashroomcrtable FROM @wa_final_master.
