CLASS zcl_crates_data DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    INTERFACES if_http_service_extension .
      CLASS-DATA it_order TYPE TABLE OF zcratesdata .
  PROTECTED SECTION.
  PRIVATE SECTION.
ENDCLASS.
...
CLASS ZCL_CRATES_DATA IMPLEMENTATION.
      ...
      WHEN CONV string( if_web_http_client=>post ).
        ...
        IF it_final_order  IS NOT INITIAL.
          ...
          LOOP AT  it_final_order INTO DATA(wa_final_order).
            ...
            MODIFY zcratesdata FROM @wa_final_order.
