...
CLASS zcl_cust_supp_fiscal_stmt IMPLEMENTATION.
  ...
  METHOD get_data_account_statement
    ...
    select
          ...
          WHEN 'DZ'
          then 'By payment receved in ' || pymtref.OffsettingAccountName ||' against ref. '|| pymtref.AssignmentReference
    ...
    from
        ZC_AccountStatement( :pCompanyCode , :pCust_Supp, :pFromDate, :pToDate, :pIsRevDoc) as item
        Left outer Join
             (
