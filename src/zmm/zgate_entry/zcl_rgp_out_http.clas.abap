class ZCL_RGP_out_HTTP definition
   public
  create public .
...
CLASS ZCL_RGP_OUT_HTTP IMPLEMENTATION.
...
*  |<form action="{ url }" method="POST">\n| &&
  |<form action="/sap/bc/http/sap/ZRGP_OUT_HTTP?sap-client=080" method="POST">\n| &&
...
*     req_uri = request->get_request_uri( ).
    ...
    req_uri = '/sap/bc/http/sap/ZRGP_OUT_HTTP?sap-client=080'.
...
*        TRANSLATE cc to UPPER CASE.
        ...
        IF lv_ge IS NOT INITIAL.
          ...
          TRY.
              DATA(pdf) = zrgp_out_driver=>read_posts( lv_gateentry = gee  ) .
