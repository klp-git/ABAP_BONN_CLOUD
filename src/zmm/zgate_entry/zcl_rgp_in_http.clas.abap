class ZCL_RGP_IN_HTTP definition
   public
  create public .
...
CLASS ZCL_RGP_IN_HTTP IMPLEMENTATION.
...
*  |<form action="{ url }" method="POST">\n| &&
  |<form action="/sap/bc/http/sap/ZRGP_IN_HTTP?sap-client=080" method="POST">\n| &&
...
*     req_uri = request->get_request_uri( ).
    ...
    req_uri = '/sap/bc/http/sap/ZRGP_IN_HTTP?sap-client=080'.
...
*        TRANSLATE cc to UPPER CASE.
        ...
        IF lv_ge IS NOT INITIAL.
          ...
          TRY.
              DATA(pdf) = zrgp_in_driver=>read_posts( lv_gateentry = gee  ) .
